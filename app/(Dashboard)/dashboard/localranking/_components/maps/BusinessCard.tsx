...
export default function BusinessCard({ id, placeData, Rank }: Props) {
  ...
  return (
    <article
      className={`flex  transition hover:shadow-xl max-w-xs  ${
        id === placeData?.place_id ? rankMap(Rank) : "bg-white"
      }`}
    >
